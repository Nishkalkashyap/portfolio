...
<!-- My first enuterpenaurial undertaking Quarkjs.io, is a full fledged application development and distribution platform for Windows, Mac and Linux based operating systems. -->
    ...
    Also, this project is a beneficiary of the Google Cloud Startup Program!
    ">
        ...
        is a full-fledged application distribution platform.
        <br/>
        <br/>
        ...
        <br/>
        <br/>
        This project was recently open-sourced on <a target='_blank' href='https://github.com/Nishkalkashyap/Quark-appstore'>GitHub.</a> 
